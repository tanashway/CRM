...
export async function GET(
  ...
  try {
    ...
    if (invoiceError || !invoice) {
      console.error('Error fetching invoice for public PDF:', invoiceError);
    ...
    if (itemsError) {
      console.error('Error fetching invoice items for public PDF:', itemsError);
    ...
    if (invoice.contact_id) {
      ...
      if (!contactError && contactData) {
        ...
        console.warn('Could not fetch contact for public PDF:', contactError);
      }
    }
